...
1. 相邻配对：元素与他们相邻的元素配对
   ![img](imgs/xianglin.png)
2. 交错配对：元素与一定距离的元素配对
   ![img](imgs/jiaocuo.png)
...
完整的可执行代码`Github:https://github.com/Tony-Tan/CUDA_Freshman`
...
![img](imgs/nvprof2.png)

```
nvprof --metrics gld_throughput ./reduceInteger
```

![img](imgs/gld_throughput2.png)
