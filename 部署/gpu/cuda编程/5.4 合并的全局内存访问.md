...
![re-1](imgs/re-1-20220325110828462.png)
transformNaiveRow的cpu计时和nvprof结果：

![re-2](imgs/re-2-20220325110828407.png)
...
copyRow:
![re-3](imgs/re-3-20220325110828262.png)
...
![re-5](imgs/re-5-20220325110828097.png)
上面这个图就是我们的转置过程
...
![re-5-5](imgs/re-5-5.png)

nvprof结果;

![re-6](imgs/re-6-20220325110828947.png)
...
![re-11](imgs/re-11.png)
还有冲突，我们改变IPAD试试（从1到2）

![re-12](imgs/re-12.png)
哈哈，冲突不见了，执行CPU计时：
