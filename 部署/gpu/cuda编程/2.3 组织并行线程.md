...
```
ix=threadIdx.x+blockIdx.x×blockDim.x ix=threadIdx.x+blockIdx.x×blockDim.x
```
...
```
iy=threadIdx.y+blockIdx.y×blockDim.y iy=threadIdx.y+blockIdx.y×blockDim.y
```
