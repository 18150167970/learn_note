...
![1-1](imgs/1-1-20220325111244355.png)

而是

![1-2](imgs/1-2-20220325111244341.png)

这样了，这就可以从抽象模型层面避免问题。
广度优先的nvvp结果是：

![nvvp-3](imgs/nvvp-3.png)
...
![re-2](imgs/re-2-20220325111244858.png)
...
![re-3](imgs/re-3-20220325111244730.png)

16个流，8个工作队列的结果：

![nvvp-4](imgs/nvvp-4.png)
...
```
https://face2ai.com/CUDA-F-6-2-并发内核执行/
```
