...
![img](imgs/2-8176704.png)

相比于[上一篇](https://face2ai.com/CUDA-F-3-4-避免分支分化/)中的效率，“高到不知道哪里去了”，比最简单的归约算法快了三倍，warmup的代码，不需要理睬。
...
这个不光是节省了多于的线程块的运行，而且更多的独立内存加载/存储操作会产生更好的性能，更好的隐藏延迟，下面我们看一下他们的吞吐量
